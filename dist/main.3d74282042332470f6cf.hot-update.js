...
var Notes = function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, function () {
                                if (newSocket_1) {
                                    (0,_services_api__WEBPACK_IMPORTED_MODULE_4__.disconnectSocket)(newSocket_1);
                                }
                            }];
                    case 2:
                        err_1 = _a.sent();
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
        if (socket && selectedNote) {
            (0,_services_api__WEBPACK_IMPORTED_MODULE_4__.joinNoteSession)(socket, selectedNote.id);
        }
    }, [socket, selectedNote]);
            ...
            switch (_e.label) {
                ...
                case 2:
                    ...
                    if (socket && !((_a = data.content) === null || _a === void 0 ? void 0 : _a.includes('data:image'))) {
                        (0,_services_api__WEBPACK_IMPORTED_MODULE_4__.sendNoteChange)(socket, {
                            noteId: noteId,
    ...
    var handleImageUpload = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(function (file) { return __awaiter(void 0, void 0, void 0, function () {
        var editor, compressedImage, updatedContent, chunks, i, start, end, chunk, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    editor = editorRef.current;
                ...
                case 3:
                    ...
                    if (!(updatedContent.length > 50000)) return [3 /*break*/, 8];
                    chunks = Math.ceil(updatedContent.length / 50000);
                    i = 0;
                    _a.label = 4;
                case 4:
                    if (!(i < chunks)) return [3 /*break*/, 7];
                    start = i * 50000;
                    end = Math.min((i + 1) * 50000, updatedContent.length);
                    chunk = updatedContent.substring(start, end);
                    return [4 /*yield*/, handleNoteUpdate(selectedNote.id, {
                            content: chunk,
                            updatedAt: new Date(),
                ...
                case 8: return [4 /*yield*/, handleNoteUpdate(selectedNote.id, {
    ...
    }); }, [selectedNote, isEditorReady, handleNoteUpdate]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("6343d6983bf2ac2ffb22")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.3d74282042332470f6cf.hot-update.js.map