...
var Notes = function () {
    ...
    var handleFolderDelete = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(function (folderId) {
        var _a;
        setFolderDeleteConfirmation({
            isOpen: true,
            folderId: folderId,
            folderName: ((_a = folders.find(function (f) { return f.id === folderId; })) === null || _a === void 0 ? void 0 : _a.name) || ''
        });
    }, [folders]);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("5c419a6aa3bf631ec32e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.ea5d516e1c7d3f59c923.hot-update.js.map